...
Numerically, dequantization is part of the forward graph but not a trainable parameterization: $W_q$ is decoded blockwise to the compute dtype, used in matmul, and discarded or cached rather than updated. Validate peak memory with long sequences because activations and temporary dequantization buffers may dominate the advertised 4-bit storage savings.
